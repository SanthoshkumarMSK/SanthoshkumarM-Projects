...
public class SerialDeSerial {
    public static void main(String args[]) throws IOException 
	  {
	    employee obj1= new employee(101, 25, "Chaitanya", "Agra","M",7878);
	    employee obj2 = new employee(111, 125, "santhosh", "Vnr","M",4566);
	    FileOutputStream fos= null;
	    ObjectOutputStream oos= null;
	    
	    try{ 
	      fos = new FileOutputStream("E:\\Work\\New folder\\employee.ser"); 
    ...
    employee o2=null;
    try{
      FileInputStream fis = new FileInputStream("E:\\\\Work\\\\New folder\\\\employee.ser");
